...
use NWTC_Library
   ...
   type :: Grid_ParameterType
      ...
      LOGICAL                      :: NoPad                                    ! Flag to indicate that output files must have as little padding as possible (i.e., only round to even)
   ...
   type Meteorology_ParameterType
     ...
     !REAL(ReKi)                   :: h                                        ! Boundary layer depth
      ...
      LOGICAL                      :: IsIECModel                               ! Flag to determine if we're using IEC scaling (coherence, etc)
         ...
         ! Temporal coherence
      REAL(ReKi)                   :: Rho        (3)                           ! Contains the concentration parameters for temporal coherence
      REAL(ReKi)                   :: Mu         (3)                           ! Contains the location parameters for temporal coherence
