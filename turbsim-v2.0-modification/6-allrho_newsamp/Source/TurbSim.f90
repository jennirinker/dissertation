...
REAL(ReKi), ALLOCATABLE          :: Rho         (:,:)       ! The temporal coherence concentration parameter (NPoints,3).
REAL(ReKi), ALLOCATABLE          :: Mu          (:,:)       ! The temporal coherence location parameter (NPoints,3).
...
CALL AllocAry(Rho,  p%grid%NPoints,3, 'Rho (concentration parameters)', ErrStat, ErrMsg )
CALL CheckError()

CALL AllocAry(Mu,   p%grid%NPoints,3, 'Mu (location parameters)', ErrStat, ErrMsg )
CALL CheckError()
