...
! get the uniformly distributed random numbers:
   ...
   DO IVec = 1,3
      DO J=1,NPoints
            ...
            ! Sample first non-zero-frequency phase randomly from uniform distirubion
         ...
         Theta = 2*PI*RN
            ...
            DO IFreq = 2,NumFreq
               ...
               C  = 2*Rho(J,IVec) / (1 + (Rho(J,IVec)**2))  ! Fisher, Equation

               RN = B*ACOS((V+C) / (1 + C*V)) + Mu(J,IVec)  ! Wrapped Cauchy random variable
