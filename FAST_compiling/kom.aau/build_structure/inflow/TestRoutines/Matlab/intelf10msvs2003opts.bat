...
rem set COMPFLAGS= /assume:byterecl /traceback /real_size:64 "/I%MATLAB%/extern/include" -c -nologo -DMATLAB_MEX_FILE /fp:source
set COMPFLAGS= /assume:byterecl /traceback "/I%MATLAB%/extern/include" -c -nologo -DMATLAB_MEX_FILE /fp:source
rem set COMPFLAGS= /assume:byterecl /traceback /Qsave /Qprec "/I%MATLAB%/extern/include" -c -nologo -DMATLAB_MEX_FILE /fp:source
