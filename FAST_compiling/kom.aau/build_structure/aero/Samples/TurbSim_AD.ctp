...
"M:\coh_events\x90_i16"		! CTSpath  - Path to coherent turbulence data files.
"TurbSim.cts"			! CTTSfile - File containing the time step of the coherent turbulence event files.
"TurbSim.wnd"			! CTbackgr - Name of file containing background (either full-field or hub-height) wind data (quoted string)
