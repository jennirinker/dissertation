...
IF ( ( TurbModel  == 'IECKAI' ) .OR. ( TurbModel  == 'IECVKM' ) .OR. ( TurbModel  == 'MODVKM' ) .OR. ( TurbModel  == 'IEC_TC' ) )  THEN

      ! If IECKAI, IECVKM, or IEC_TC spectral models are specified, determine turb intensity 
...
ENDIF !  TurbModel  == 'IECKAI', 'IECVKM', 'MODVKM', or 'IEC_TC'
