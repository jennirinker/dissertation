...
---------------------- INITIAL CONDITIONS --------------------------------------
   2.5     OoPDefl     - Initial out-of-plane blade-tip displacement (meters)
  ...
  10.0     RotSpeed    - Initial or fixed rotor speed (rpm)
   ...
   0.4     TTDspFA     - Initial fore-aft tower-top displacement (meters)
...
---------------------- AERODYN -------------------------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\FAST_models\FAST7\WP5.0A04V00\WP5.0A04V00_42331_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
