...
REAL(4), PARAMETER           :: CornerFreq    =       3.926991                  ! Corner frequency (-3dB point) in the recursive, single-pole, low-pass filter, rad/s. -- chosen to be 1/4 the blade edgewise natural frequency ( 1/4 of approx. 1Hz = 0.25Hz = 1.570796rad/s)
...
REAL(4), PARAMETER           :: PC_DT         = 0.02500                         ! Communication interval for pitch  controller, sec.
REAL(4), PARAMETER           :: PC_GSPit1     = 0.04538                         ! Starting angle for gain scheduling [rad]
REAL(4), PARAMETER           :: PC_GSPit2     = 0.52360                         ! Ending angle for gain scheduling [rad]
REAL(4), PARAMETER           :: PC_GSCoef     = 0.21302                         ! Gain scheduling coefficient
REAL(4), PARAMETER           :: PC_GSExp      = -0.50000                        ! Gain scheduling exponent
REAL(4), PARAMETER           :: PC_KD         =       0.000075900               ! Derivative gain for pitch controller at rated pitch angle, (-).
REAL(4), PARAMETER           :: PC_KI         =       0.005888700               ! Integral gain for pitch controller at rated pitch angle, (-).
REAL(4), PARAMETER           :: PC_KP         =       0.013634300               ! Proportional gain for pitch controller at rated pitch (zero), sec.
REAL(4), PARAMETER           :: PC_MaxPit     =       1.5707963                 ! Maximum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_MaxRat     =       0.1745329                 ! Maximum pitch  rate (in absolute value) in pitch  controller, rad/s.
REAL(4), PARAMETER           :: PC_MinPit     =       0.0453786                 ! Minimum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_RefSpd     =     188.4956                    ! Desired (reference) HSS speed for pitch controller, rad/s.
...
REAL(4), PARAMETER           :: VS_CtInSp     =       0.00000                   ! Transitional generator speed (HSS side) between regions 1 and 1 1/2, rad/s.
...
REAL(4), PARAMETER           :: VS_MaxTq      =    4607.12                      ! Maximum generator torque in Region 3 (HSS side), N-m. -- chosen to be 10% above VS_RtTq = 43.09355kNm
REAL(4), PARAMETER           :: VS_Rgn2K      =       0.001293                  ! Generator torque constant in Region 2 (HSS side), N-m/(rad/s)^2.
REAL(4), PARAMETER           :: VS_Rgn2Sp     =       0.00000                   ! Transitional generator speed (HSS side) between regions 1 1/2 and 2, rad/s.
REAL(4), PARAMETER           :: VS_Rgn3MP     =       0.06283185                ! Minimum pitch angle at which the torque is computed as if we are in region 3 regardless of the generator speed, rad. -- chosen to be 1.0 degree above PC_MinPit
REAL(4), PARAMETER           :: VS_RtGnSp     =     188.4956                    ! Rated generator speed (HSS side), rad/s. -- chosen to be 99% of PC_RefSpd
REAL(4), PARAMETER           :: VS_RtPwr      =  789473.7                       ! Rated generator generator power in Region 3, Watts. -- chosen to be 5MW divided by the electrical generator efficiency of 94.4%
