...
---------------------- TURBINE CONFIGURATION -----------------------------------
  25.0      TipRad      - The distance from the rotor apex to the blade tip (meters)
  ...
  -2.3      OverHang    - Distance from yaw axis to rotor apex [3 blades] or teeter pin [2 blades] (meters)
...
6.5739e+03  HubMass     - Hub mass (kg)
  ...
  8.62e+03  NacYIner    - Nacelle inertia about yaw axis (kg m^2)
...
"unused"    DynBrkFi    - File containing a mech-gen-torque vs HSS-speed curve for a dynamic brake [CURRENTLY IGNORED] (quoted string)
 ...
 2.3e+05    DTTorDmp    - Drivetrain torsional damper (N-m/(rad/s))
...
---------------------- BLADE ---------------------------------------------------
"WP0.75A08V00_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
...
---------------------- ADAMS ---------------------------------------------------
"WP0.75A08V00_ADAMS.dat"    ADAMSFile  - Name of file containing ADAMS-specific input parameters (quoted string) [unused when ADAMSPrep=1]
