...
{:10.6}  VS_Rgn2K    - Generator torque constant in Region 2 for simple variable-speed generator control (HSS side) (N-m/rpm^2) [used only when VSContrl=1]
...
{:6.1}      PreCone(1)  - Blade 1 cone angle (degrees)
{:6.1}      PreCone(2)  - Blade 2 cone angle (degrees)
{:6.1}      PreCone(3)  - Blade 3 cone angle (degrees) [unused for 2 blades]
   0.0      AzimB1Up    - Azimuth value to use for I/O when blade 1 points up (degrees)
---------------------- MASS AND INERTIA ----------------------------------------
   0.0      YawBrMass   - Yaw bearing mass (kg)
{:10.3g}  NacMass     - Nacelle mass (kg)
{:10.3g}  HubMass     - Hub mass (kg)
...
{:10.3g}    GenIner     - Generator inertia about HSS (kg m^2)
{:10.3g}  HubIner     - Hub inertia about rotor axis [3 blades] or teeter axis [2 blades] (kg m^2)
---------------------- DRIVETRAIN ----------------------------------------------
