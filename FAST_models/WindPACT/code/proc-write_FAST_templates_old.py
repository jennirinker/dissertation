...
if (TmplType == 1):
    BldModesInp, TwrModesInp = 1,1
    BladeInp,ADInp,TowerInp,FASTInp,PitchInp,DISCONInp = 0,0,0,0,0,0
elif (TmplType == 2):
    BldModesInp, TwrModesInp = 0,0
    BladeInp,ADInp,TowerInp,FASTInp,PitchInp = 1,1,1,1,1
    DISCONInp = 0
