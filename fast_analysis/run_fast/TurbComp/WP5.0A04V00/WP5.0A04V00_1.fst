--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
FAST v7.02 input file for turbine "WP5.0A04V00"
Generated by J. Rinker (Duke University) on 30-Dec-15 based on WindPACT Excel input files
---------------------- SIMULATION CONTROL --------------------------------------
...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
  10.4      BlPitch(1)  - Blade 1 initial pitch (degrees)
  10.4      BlPitch(2)  - Blade 2 initial pitch (degrees)
  10.4      BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades]
...
---------------------- INITIAL CONDITIONS --------------------------------------
   1.8     OoPDefl     - Initial out-of-plane blade-tip displacement (meters)
  -0.4     IPDefl      - Initial in-plane blade-tip deflection (meters)
   0.0     TeetDefl    - Initial or fixed teeter angle (degrees) [unused for 3 blades]
 179.5     Azimuth     - Initial azimuth angle for blade 1 (degrees)
  11.2     RotSpeed    - Initial or fixed rotor speed (rpm)
   0.0     NacYaw      - Initial or fixed nacelle-yaw angle (degrees)
   0.3     TTDspFA     - Initial fore-aft tower-top displacement (meters)
  -0.1     TTDspSS     - Initial side-to-side tower-top displacement (meters)
...
"C:\Users\jrinker\Documents\GitHub\dissertation\FAST_models\FAST7\WP5.0A04V00\WP5.0A04V00_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\FAST_models\FAST7\WP5.0A04V00\WP5.0A04V00_Blade.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"C:\Users\jrinker\Documents\GitHub\dissertation\FAST_models\FAST7\WP5.0A04V00\WP5.0A04V00_Blade.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"C:\Users\jrinker\Documents\GitHub\dissertation\FAST_models\FAST7\WP5.0A04V00\WP5.0A04V00_Blade.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\fast_analysis\run_fast\TurbComp\WP5.0A04V00\WP5.0A04V00_1_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
"unused"    NoiseFile   - Name of file containing aerodynamic noise input parameters (quoted string) [used only when CompNoise=True]
---------------------- ADAMS ---------------------------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\FAST_models\FAST7\WP5.0A04V00\WP_Template_ADAMS.dat"    ADAMSFile  - Name of file containing ADAMS-specific input parameters (quoted string) [unused when ADAMSPrep=1]
---------------------- LINEARIZATION CONTROL -----------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\FAST_models\FAST7\WP5.0A04V00\WP_Template_Linear.dat"   LinFile    - Name of file containing FAST linearization parameters (quoted string) [unused when AnalMode=1]
---------------------- OUTPUT --------------------------------------------------
