...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
   9.6      BlPitch(1)  - Blade 1 initial pitch (degrees)
   9.6      BlPitch(2)  - Blade 2 initial pitch (degrees)
   9.6      BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades]
...
---------------------- INITIAL CONDITIONS --------------------------------------
   2.0     OoPDefl     - Initial out-of-plane blade-tip displacement (meters)
  -0.4     IPDefl      - Initial in-plane blade-tip deflection (meters)
   0.0     TeetDefl    - Initial or fixed teeter angle (degrees) [unused for 3 blades]
 179.3     Azimuth     - Initial azimuth angle for blade 1 (degrees)
...
---------------------- AERODYN -------------------------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\fast_analysis\run_fast\TurbComp\WP5.0A04V00\WP5.0A04V00_0_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
