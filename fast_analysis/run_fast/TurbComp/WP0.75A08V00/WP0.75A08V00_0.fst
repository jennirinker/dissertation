...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
  11.4      BlPitch(1)  - Blade 1 initial pitch (degrees)
  11.4      BlPitch(2)  - Blade 2 initial pitch (degrees)
  11.4      BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades]
...
---------------------- INITIAL CONDITIONS --------------------------------------
   0.7     OoPDefl     - Initial out-of-plane blade-tip displacement (meters)
  -0.2     IPDefl      - Initial in-plane blade-tip deflection (meters)
   0.0     TeetDefl    - Initial or fixed teeter angle (degrees) [unused for 3 blades]
 180.3     Azimuth     - Initial azimuth angle for blade 1 (degrees)
...
---------------------- AERODYN -------------------------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\fast_analysis\run_fast\TurbComp\WP0.75A08V00\WP0.75A08V00_0_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
