...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
  10.5      BlPitch(1)  - Blade 1 initial pitch (degrees)
  10.5      BlPitch(2)  - Blade 2 initial pitch (degrees)
  10.5      BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades]
...
---------------------- INITIAL CONDITIONS --------------------------------------
 ...
 179.0     Azimuth     - Initial azimuth angle for blade 1 (degrees)
...
---------------------- AERODYN -------------------------------------------------
"C:\Users\jrinker\Documents\GitHub\dissertation\fast_analysis\run_fast\TurbComp\WP3.0A02V02\WP3.0A02V02_1_AD.ipt"         ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
